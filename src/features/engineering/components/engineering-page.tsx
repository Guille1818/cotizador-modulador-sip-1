                ...
                <div className="flex flex-col gap-4 overflow-y-auto pr-2 custom-scrollbar lg:max-h-[calc(100vh-120px)] pb-20 lg:pb-0">
                    ...
                    <div className="bg-white p-5 rounded-3xl border border-slate-200 shadow-sm space-y-6">
                        <div className="space-y-4">
                            <div className="flex items-center gap-2 border-b border-slate-100 pb-2 mb-4">
                                ...
                                <h3 className="text-[10px] font-black text-slate-800 uppercase tracking-widest">Geometria Base</h3>
                            </div>
                            <div className="grid grid-cols-3 gap-2">
                                <button
                                    onClick={() => clearRecesses()}
                                    className={`flex flex-col items-center gap-1 p-3 rounded-2xl border-2 transition-all group ${(project as any).recesses?.length === 0 ? 'bg-indigo-50 border-indigo-500 text-indigo-700' : 'border-slate-100 text-slate-400 hover:border-indigo-500 hover:bg-indigo-50'}`}
                                >
                                    <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${(project as any).recesses?.length === 0 ? 'bg-indigo-500 text-white' : 'bg-slate-100 text-slate-400 group-hover:bg-indigo-500 group-hover:text-white'}`}>
                                        <Square size={16} />
                                    </div>
                                    <span className="text-[9px] font-black uppercase tracking-tighter">Rectangulo</span>
                                </button>
                                <button
                                    onClick={() => addLShape()}
                                    className={`flex flex-col items-center gap-1 p-3 rounded-2xl border-2 transition-all group ${(project as any).recesses?.length === 1 && (project as any).recesses[0].side === 'Sur' ? 'bg-indigo-50 border-indigo-500 text-indigo-700' : 'border-slate-100 text-slate-400 hover:border-indigo-500 hover:bg-indigo-50'}`}
                                >
                                    <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${(project as any).recesses?.length === 1 && (project as any).recesses[0].side === 'Sur' ? 'bg-indigo-500 text-white' : 'bg-slate-100 text-slate-400 group-hover:bg-indigo-500 group-hover:text-white'}`}>
                                ...
                                <button
                                    onClick={() => addCShape()}
                                    className={`flex flex-col items-center gap-1 p-3 rounded-2xl border-2 transition-all group ${(project as any).recesses?.length === 1 && (project as any).recesses[0].side === 'Norte' ? 'bg-indigo-50 border-indigo-500 text-indigo-700' : 'border-slate-100 text-slate-400 hover:border-indigo-500 hover:bg-indigo-50'}`}
                                >
                                    <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${(project as any).recesses?.length === 1 && (project as any).recesses[0].side === 'Norte' ? 'bg-indigo-500 text-white' : 'bg-slate-100 text-slate-400 group-hover:bg-indigo-500 group-hover:text-white'}`}>
                    ...
                    <div className="bg-white p-5 rounded-3xl border border-slate-200 shadow-sm">
                        <div className="flex items-center gap-2 border-b border-slate-100 pb-2 mb-4">
                            ...
                            <h3 className="text-[10px] font-black text-slate-800 uppercase tracking-widest">Inclusion de Fachadas</h3>
                        </div>
                    ...
                    <div className="bg-white p-5 rounded-3xl border border-slate-200 shadow-sm">
                        <div className="flex items-center gap-2 border-b border-slate-100 pb-2 mb-4">
                            <div className="w-2 h-2 bg-emerald-500 rounded-full"></div>
                            <h3 className="text-[10px] font-black text-slate-800 uppercase tracking-widest">Configuracion Estructural</h3>
                        </div>
                        <div className="space-y-4">
                            <div className="space-y-2">
                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest block ml-1">Cimentacion</label>
                                <div className="grid grid-cols-2 gap-2">
                            ...
                            <div className="space-y-4 pt-4 border-t border-slate-50">
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    <button
                                        ...
                                        className={`py-2 rounded-xl text-[10px] font-black border-2 transition-all ${(selections as any).roofSystem === 'sip' ? 'bg-orange-50 border-orange-500 text-orange-700' : 'border-slate-100 text-slate-400'}`}
                                    >
                                        TECHO SIP
                                    </button>
                                    <button
                                        onClick={() => setRoofSystem('sandwich')}
                                        className={`py-2 rounded-xl text-[10px] font-black border-2 transition-all ${(selections as any).roofSystem === 'sandwich' ? 'bg-orange-50 border-orange-500 text-orange-700' : 'border-slate-100 text-slate-400'}`}
                                    >
                                        SANDWICH
                                    </button>
                                </div>
                            ...
                            {/* Configuracion de Componentes Removed by User Request */}
                        </div>
                    </div>
                    ...
                    <div className="bg-slate-900 rounded-[40px] p-6 text-slate-300 font-mono text-[10px]">
                        <div className="flex justify-between items-center mb-4 border-b border-white/10 pb-2">
                            <span className="text-cyan-400 font-black">REPORTE TECNICO</span>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="pt-6 border-t-2 border-white/10 space-y-2">
                                <h4 className="text-white/40 text-[9px] uppercase font-black mb-3 tracking-widest">GEOMETRIA Y ABERTURAS</h4>
